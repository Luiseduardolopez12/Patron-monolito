...
public class LibrosController : ControllerBase
{
    ...
    public async Task<IActionResult> Create(Libro libro)
    {
        ...
        // Asegurar que el año de publicación sea numérico y esté en un rango válido
        if (!int.TryParse(libro.AnioPublicacion?.ToString(), out var anio) || anio < 1440 || anio > DateTime.Now.Year)
